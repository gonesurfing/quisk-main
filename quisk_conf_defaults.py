### This is the file quisk_conf_defaults.py that contains defaults for Quisk.
###
...
# of the space needed for all the buttons.  The special size 1.0 means full screen.
graph_width = 0.8
...
# use_rx_udp = 10							# This must be 10 to specify the original Ethernet Hermes protocol
# rx_udp_clock = 73728000					# The clock is 73.728 or 61.440 megahertz.  Adjust for actual frequency.
# rx_udp_ip = ""							# Null string for DHCP, else specify an IP address
...
# hermes devices, you can use these to specify a unique device.
hermes_code_version = -1					# -1 for any Code Version, else the Code Version of the Hermes.
hermes_board_id = -1						# -1 for any Board ID, else the Board ID of the Hermes.
...
hamlib_ip = "localhost"	# IP address for Hamlib
...
# is an entry in the "offset" column, and the mode is FM, and this parameter is True,
...
use_sidetone = 0            # No sidetone, and no Sto sidetone volume control
# use_sidetone = 1          # Add the Sto sidetone volume control, and generate a sidetone
#
